...
// Dynamic import for AuthModalController (lazy load)
const AuthModalController = dynamic(
  () =>
    import("@/components/auth-dialog-controller").then(
      (mod) => mod.AuthModalController
    ),
  {
    ssr: false,
    loading: () => null,
              ...
              {[
                {
                  ...
                  desc: "Browse thousands of roles listings tailored to your skills and experience.",
                },
                {
                  icon: <Users className="h-6 w-6 text-primary" />,
                  title: "Connect with Us",
                  desc: "Directly communicate with hiring managers and recruiters.",
                },
                {
                  icon: <Award className="h-6 w-6 text-primary" />,
                  title: "Land Your Dream Job",
                  desc: "Get hired with our proven process and support throughout your journey.",
                },
                {
                  icon: <Users className="h-6 w-6 text-primary" />,
                  title: "Talent Matching",
                  desc: "Our AI-powered system matches the right candidates with the right jobs.",
                },
              ...
              {[
                {
                  ...
                  text: "Lorem ipsum dolor sit amet consectetur adipisicing, elit. Placeat aliquid dolore, quo!",
                },
                {
                  name: "Andrew Fisabilillah",
                  role: "HR Director",
                  text: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Delectus sunt, dignissimos laudantium.",
                },
                {
                  name: "Farros Anwari",
                  role: "Marketing Manager",
                  text: "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptate molestias ratione eaque qui rem.",
                },
              ].map(({ name, role, text }, i) => (
                <div key={i} className="bg-background p-6 rounded-lg shadow-sm">
                  <div className="flex items-center mb-4">
                    <div className="h-10 w-10 rounded-full bg-primary/10 mr-3" />
                    <div>
